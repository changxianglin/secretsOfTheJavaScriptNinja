...
*
* 6.3.4 创建一个真是 promise 案例
* 客户端最通用的异步任务就是从服务器获取数据，同样，这也是一个非常好的用于学习如何使用 promise 的
* 小案例。
*
* 6.3.5 链式调用 promise
* 嵌套太深将形成难以维护的回调函数序列，由于 promise 可以链式调用，故它也是用于解决该问题的重要一步。
*
* promise 链中的错误捕获
*
* 6.3.6 等待多个 promise
* 除了处理相互依赖的异步任务序列以外，对于等待多个独立的异步任务，promise 也能够显著地减少代码量，
* 让我们再看一个并行执行的例子。
*
* 6.3.7 promise 竞赛
* 假设我们可以支配一队忍者，我们希望第一个回答命令的"忍者"分配一个任务。
*
* 6.4 把生成器和 promise 相结合
* 我们将生成器（以及生成器暂停和恢复执行的能力）和 promise， 来实现更加优雅的异步代码。
*
* 面向未来的 async 函数
*
* */